...
st.write('<div class="fixed-container"><img src="https://github.com/marceloyuba/StreamlitSDT/blob/main/scr/SDTLogoC.png?raw=true" /><br><img src="https://github.com/marceloyuba/StreamlitSDT/blob/main/scr/Logo_Buenos_Aires.png?raw=true" /></div>', unsafe_allow_html=True)
st.title("") 
